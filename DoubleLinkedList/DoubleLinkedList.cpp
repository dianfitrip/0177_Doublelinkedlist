...
void deleteNode() {
	...
	if (current == START) {
		...
		if (current->next != NULL) {									// if there's a successor, update its prev pointer
...
int main() {
	...
	while (true)
	{
		try
		{
			...
			cout << "4. View all records in the descending oreder of roll numbers" << endl;
			cout << "5. Search for a record in the list" << endl;
			cout << "6. Exit" << endl;
			cout << "\nEnter you choise (1-6): ";
			char ch;
			cin >> ch;
